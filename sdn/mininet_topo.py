...
def run():
    ...
    print("    h1 ping h2")
    print("    pingall")
    print("\n  Attack Scenarios (Triggers BLOCK):")
    ...
    print("\n  ML-Only Anomalies (Triggers RATE_LIMIT):")
    print("    h1 bash scripts/attacks.sh covert_channel 10.0.1.2")
    print("    h1 bash scripts/attacks.sh atypical_proto 10.0.1.2")
